!(function (e, t) {
    ...
    var p = (function (n) {
        ...
        (oe.matchesSelector = function (e, t) {
            if (((e.ownerDocument || e) !== T && E(e), (t = t.replace(z, "='$1']")), d.matchesSelector && x && !A[t + " "] && (!a || !a.test(t)) && (!m || !m.test(t))))
                try {
                    var n = c.call(e, t);
            ...
            preFilter: {
                ...
                PSEUDO: function (e) {
                    ...
                    return K.CHILD.test(e[0])
                        ? null
                        : (e[3] ? (e[2] = e[4] || e[5] || "") : n && Q.test(n) && (t = p(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && ((e[0] = e[0].slice(0, t)), (e[2] = n.slice(0, t))), e.slice(0, 3));
                },
            },
            filter: {
                TAG: function (e) {
                              ...
                              if (c) {
                                  ...
                                  if (((l = [y ? c.firstChild : c.lastChild]), y && h)) {
                                      ...
                                      for (
                                          ;
                                          (s = (++a && s && s[u]) || (d = a = 0) || l.pop()) &&
                                          ((b ? s.nodeName.toLowerCase() !== f : 1 !== s.nodeType) || !++d || (h && ((r = (o = s[C] || (s[C] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] = [S, d]), s !== e));
        ...
        return (
            ...
            (p = oe.tokenize = function (e, t) {
                ...
                for (s = e, a = [], l = _.preFilter; s; ) {
                    ...
                    (n = !1),
                    (i = U.exec(s)) && ((n = i.shift()), r.push({ value: n, type: i[0].replace(F, " ") }), (s = s.slice(n.length))),
                    _.filter))
                    ...
                    ? ("none" === n && ((u[c] = X.get(i, "display") || null), u[c] || (i.style.display = "")),
                      "" === i.style.display &&
                          ...
                          (u[c] =
                              ...
                              (s = (r = i).ownerDocument),
                              (a = r.nodeName),
                              (l = ae[a]) || ((o = s.body.appendChild(s.createElement(a))), (l = C.css(o, "display")), o.parentNode.removeChild(o), "none" === l && (l = "block"), (ae[a] = l)))))
    ...
    function ye(e, t, n, i, r) {
        ...
        for (f.textContent = "", d = 0; (o = h[d++]); )
            ...
            else if (((u = C.contains(o.ownerDocument, o)), (s = de(f.appendChild(o), "script")), u && pe(s), n)) for (c = 0; (o = s[c++]); ) fe.test(o.type || "") && n.push(o);
        return f;
    }
        ...
        if (f && ((t = (e = ye(i, n[0].ownerDocument, !1, n, o)).firstChild), 1 === e.childNodes.length && (e = t), t || o)) {
            ...
            if (a)
                for (u = s[s.length - 1].ownerDocument, C.map(s, Le), c = 0; c < a; c++)
                    (l = s[c]), fe.test(l.type || "") && !X.access(l, "globalEval") && C.contains(u, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && C._evalUrl(l.src) : _(l.textContent.replace(Ie, ""), u, l));
        }
        return n;
    }
    function Pe(e, t, n) {
    ...
    function We(e, t, n) {
        ...
        return (
            (n = n || Re(e)) &&
                ...
                !v.pixelBoxStyles() && qe.test(s) && Me.test(t) && ((i = a.width), (r = a.minWidth), (o = a.maxWidth), (a.minWidth = a.maxWidth = a.width = s), (s = n.width), (a.width = i), (a.minWidth = r), (a.maxWidth = o))),
            void 0 !== s ? s + "" : s
        );
    }
    function Fe(e, t) {
    ...
    function Ge(e, t, n) {
        ...
        return (
            ...
            ("auto" === r || (!parseFloat(r) && "inline" === C.css(e, "display", !1, i))) && ((r = e["offset" + t[0].toUpperCase() + t.slice(1)]), (s = !0)),
    ...
    C.extend({
        ...
        C.each(["height", "width"], function (e, a) {
            C.cssHooks[a] = {
                get: function (e, t, n) {
                    if (t)
                        return !Be.test(C.css(e, "display")) || (e.getClientRects().length && e.getBoundingClientRect().width)
                            ? Ge(e, a, n)
                            : oe(e, ze, function () {
                                  return Ge(e, a, n);
                              });
                ...
                set: function (e, t, n) {
                    var i,
                        ...
                        s = n && Xe(e, a, n, o, r);
                    return (
                        o && v.scrollboxSize() === r.position && (s -= Math.ceil(e["offset" + a[0].toUpperCase() + a.slice(1)] - parseFloat(r[a]) - Xe(e, a, "border", !1, r) - 0.5)),
    ...
    (C.Animation = C.extend(ut, {
            ...
            function (e, t, n) {
                ...
                if ((l = !C.isEmptyObject(t)) || !C.isEmptyObject(d))
                    for (i in (f &&
                        ...
                        "none" === (c = C.css(e, "display")) && (u ? (c = u) : (le([e], !0), (u = e.style.display || u), (c = C.css(e, "display")), le([e]))),
        ...
        C.each({ slideDown: at("show"), slideUp: at("hide"), slideToggle: at("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (e, i) {
            ...
            attr: function (e, t, n) {
                ...
                if (3 !== o && 8 !== o && 2 !== o)
                    return void 0 === e.getAttribute
                        ? C.prop(e, t, n)
                        : ((1 === o && C.isXMLDoc(e)) || (r = C.attrHooks[t.toLowerCase()] || (C.expr.match.bool.test(t) ? ct : void 0)),
                          void 0 !== n
                              ? null === n
        ...
        C.fn.extend({
            ...
            toggleClass: function (r, t) {
                ...
                return "boolean" == typeof t && s
                    ...
                    : this.each(function () {
                          var e, t, n, i;
                          if (s) for (t = 0, n = C(this), i = mt(r); (e = i[t++]); ) n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
            ...
            ajax: function (e, t) {
                ...
                m.hasContent
                    ...
                    : ((o = m.url.slice(f.length)),
                      m.data && (m.processData || "string" == typeof m.data) && ((f += (Et.test(f) ? "&" : "?") + m.data), delete m.data),
            ...
            if (v.cors || (Bt && !r.crossDomain))
                return {
                    send: function (e, t) {
                        var n,
                            i = r.xhr();
                        if ((i.open(r.type, r.url, true, r.username, r.password), r.xhrFields)) for (n in r.xhrFields) i[n] = r.xhrFields[n];
                        for (n in (r.mimeType && i.overrideMimeType && i.overrideMimeType(r.mimeType), r.crossDomain || e["X-Requested-With"] || (e["X-Requested-With"] = "XMLHttpRequest"), e)) i.setRequestHeader(n, e[n]);
                        (o = function (e) {
                            return function () {
                                o &&
        ...
        (C.parseHTML = function (e, t, n) {
            return "string" != typeof e
                ...
                : ("boolean" == typeof t && ((n = t), (t = !1)),
                  ...
                  (o = !n && []),
                  (r = N.exec(e)) ? [t.createElement(r[1])] : ((r = ye([e], t, o)), o && o.length && C(o).remove(), C.merge([], r.childNodes)));
            var i, r, o;
        }),
                        ...
                        fn: function (e, t) {
                            ...
                            var s,
                                ...
                                x =
                                    ...
                                    (b = a ? f : d),
                                    { left: (y = a ? (m || v || p % 2 == g % 2 ? f : h) : d)(p % 2 == 1 && g % 2 == 1 && !v && a ? u.left - 1 : u.left), top: b(u.top), bottom: b(u.bottom), right: y(u.right) }),
            ...
            Yt = (function () {
                ...
                return (
                    ...
                    (u._dataApiKeydownHandler = function (e) {
                        if (
                            (/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || (27 !== e.which && ((40 !== e.which && 38 !== e.which) || p(e.target).closest(Rt).length))) : At.test(e.which)) &&
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                            ...
                            p(r).data(this.constructor.DATA_KEY, this),
                                ...
                                (this._popper = new wt(this.element, r, {
                                    placement: a,
                                    modifiers: { offset: this._getOffset(), flip: { behavior: this.config.fallbackPlacement }, arrow: { element: Rn }, preventOverflow: { boundariesElement: this.config.boundary } },
                                    onCreate: function (e) {
                    ...
                    this.each(function () {
                        ...
                        if (h.parent().hasClass(A.wrapperClass)) {
                            ...
                            y.css(_),
                                ...
                                T(),
                                "bottom" === A.start ? (b.css({ top: h.outerHeight() - b.outerHeight() }), E(0, !0)) : "top" !== A.start && (E(D(A.start).position().top, null, !0), A.alwaysVisible || b.hide()),
                                (v = this),
                                ...
                                .on(u.CLICK_DATA_API, function (e) {
                                    ...
                                    s.preventDefault && e.preventDefault(),
                                        "true" !== t.attr("aria-disabled") &&
                                            (n.hasClass(s.activeClass) ? (t.attr("aria-expanded", !1), o.hide(r)) : (o.show(r), t.attr("aria-expanded", !0), s.toggle && i.attr("aria-expanded", !1)),
                        ...
                        if (!this.transitioning && a(e).hasClass(this.config.collapseInClass)) {
                            ...
                            if ((n.trigger(i), !i.isDefaultPrevented())) {
                                ...
                                var r = function () {
                                    t.config &&
                                        t.element &&
                                        (t.transitioning && t.config.onTransitionEnd && t.config.onTransitionEnd(), t.setTransitioning(!1), n.trigger(u.HIDDEN), n.removeClass(t.config.collapsingClass).addClass(t.config.collapseClass));
                                };
                ...
                (e = {
                    ...
                    for (var s in this.waypoints[r]) {
                        ...
                        f.element !== f.element.window && (p = f.adapter.offset()[o.offsetProp]),
                            "function" == typeof h ? (h = h.apply(f)) : "string" == typeof h && ((h = parseFloat(h)), -1 < f.options.offset.indexOf("%") && (h = Math.ceil((o.contextDimension * h) / 100))),
                            ...
                            d.data("counterup-func", function () {
                                d.data("counterup-nums")
                                    ? (d.html(d.data("counterup-nums").shift()),
                                      d.data("counterup-nums").length ? setTimeout(d.data("counterup-func"), p.delay) : (d.data("counterup-nums", null), d.data("counterup-func", null), m.callback.call(this)))
