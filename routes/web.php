...
/*
Route::get('register/investor', 'Auth\RegisterController@showRegistrationForm')->name('investor');
Route::get('register/entrepreneur', 'Auth\RegisterController@showRegistrationForm')->name('entrepreneur');
...
/*
Route::get('entrepreneurs/prerequisite', 'PageController@entrepreneursPre')->name('pre.entrepreneurs');
Route::get('investor/prerequisite', 'PageController@investorPre')->name('pre.investor');*/
/**
Users Routes
************/
Route::group(['middleware' => ['auth', 'is_user']], function() {
    ...
    ******************/
    ...
    /*
    Route::get('business-proposals/create', 'BusinessProposalController@create')->name('business.proposals.create');

    Route::post('business-proposals/create', 'BusinessProposalController@store')->name('business.proposals.store');
    Route::delete('business-proposals/{id}', 'BusinessProposalController@destroy')->name('business.proposals.destroy');
    Route::get('business-proposals/{slug}/edit', 'BusinessProposalController@edit')->name('business.proposals.edit');
    Route::put('business-proposals/{slug}/edit', 'BusinessProposalController@update')->name('business.proposals.update');
    

    Route::get('business-proposals/favourites', 'BusinessProposalController@favourites')->name('business.proposals.favourites');

    Route::get('my-business-proposals', 'BusinessProposalController@myProposal')->name('business.proposals.my');
    */
    ...
    ******************/
    ...
    Route::post('resource/create', 'ResourceController@store')->name('resource.store');
    Route::delete('resource/{id}', 'ResourceController@destroy')->name('resource.destroy');
    Route::get('resource/{slug}/edit', 'ResourceController@edit')->name('resource.edit');
    Route::put('resource/{slug}/edit', 'ResourceController@update')->name('resource.update');
    Route::get('resource/favourites', 'ResourceController@favourites')->name('resource.favourites');

    Route::get('my-resource', 'ResourceController@myResource')->name('resource.my');
    */
    
    /**
    Investor
    ********/
    //Route::get('investors', 'UserController@investors')->name('user.investors');
    ...
    **********/
    ...
    /*
    Route::post('business-proposals/favourites', 'BusinessProposalController@filterFavourite')->name('business.proposals.favourite.filter');
    Route::post('business-proposal/favourite/create', 'FavouriteController@store')->name('business.proposals.favourite.create');
    Route::post('resource/favourites', 'ResourceController@filterFavourite')->name('resource.favourite.filter');
    Route::post('resource/favourite/create', 'FavouriteController@store')->name('resource.favourite.create');
    */
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'is_admin']], function() {
    ...
    ******************/
    ...
    /*
    Route::get('business-proposals', 'BusinessProposalController@adminIndex')->name('business.proposals');
    Route::get('business-proposals/create', 'BusinessProposalController@create')->name('business.proposals.create');
    Route::post('business-proposals/create', 'BusinessProposalController@store')->name('business.proposals.store');
    ...
    Route::post('business-proposals', 'BusinessProposalController@filter')->name('business.proposals.filter');
    Route::get('business-proposal/{slug}', 'BusinessProposalController@show')->name('business.proposals.show');

    Route::get('business-proposals/{slug}/status/{status}', 'BusinessProposalController@status')->name('business.proposals.status');
    */
    ...
    ******************/
    ...
    /*
    Route::get('resources/create', 'ResourceController@create')->name('resource.create');
    Route::post('resources/create', 'ResourceController@store')->name('resource.store');

    Route::get('resources', 'ResourceController@adminIndex')->name('resource');
    Route::get('resource/{slug}', 'ResourceController@show')->name('resource.show');
    Route::post('resources', 'ResourceController@filter')->name('resource.filter');

    Route::delete('resource/{id}', 'ResourceController@destroy')->name('resource.destroy');
    Route::get('resource/{slug}/edit', 'ResourceController@edit')->name('resource.edit');
    Route::put('resource/{slug}/edit', 'ResourceController@update')->name('resource.update');

    Route::get('resource/{slug}/status/{status}', 'ResourceController@status')->name('resource.status');
    */
    ...
    **********/
    ...
    /*
    Route::get('assistants', 'UserController@assistants')->name('user.assistants');
    Route::get('assistants/create', 'UserController@createAssistant')->name('user.create.assistants');    
    */
    ...
    **********/
    ...
    /*
    Route::get('blogs', 'BlogController@adminIndex')->name('blog');
    ...
    Route::post('blogs', 'BlogController@filter')->name('blog.filter');

    Route::delete('blogs/{id}', 'BlogController@destroy')->name('blog.destroy');
    Route::get('blogs/{slug}/edit', 'BlogController@edit')->name('blog.edit');
    Route::put('blogs/{slug}/edit', 'BlogController@update')->name('blog.update');
    */
    ...
    **********/
    ...
    /*
    Route::get('blog-category', 'BlogCategoryController@index')->name('blog.category');
    Route::get('blog-category/create', 'BlogCategoryController@create')->name('blog.category.create');
    Route::post('blog-category/create', 'BlogCategoryController@store')->name('blog.category.store');
    Route::delete('blog-category/{id}', 'BlogCategoryController@destroy')->name('blog.category.destroy');
    Route::get('blog-category/{slug}/edit', 'BlogCategoryController@edit')->name('blog.category.edit');
    Route::put('blog-category/{slug}/edit', 'BlogCategoryController@update')->name('blog.category.update');
    */
    ...
    *************/
    ...
    /*
    Route::get('business-proposals/categories', 'BusinessTypeController@index')->name('b.bt');
    Route::get('resources/categories', 'BusinessTypeController@index')->name('r.bt');
    Route::get('business-proposals/business-type/create', 'BusinessTypeController@index')->name('bt.create');
    Route::get('resources/business-type/create', 'BusinessTypeController@index')->name('r.create');
    Route::post('business-type/create', 'BusinessTypeController@store')->name('bt.store');
    Route::delete('business-type/{id}', 'BusinessTypeController@destroy')->name('bt.destroy');
    Route::get('business-type/{id}/edit', 'BusinessTypeController@edit')->name('bt.edit');
    Route::put('business-type/{id}/edit', 'BusinessTypeController@update')->name('bt.update');
    */
    
    /**
    Prerequiste Questions
    ********************/
    
    /*
    Route::get('questions', 'PreferenceQuestionController@index')->name('question.list');
    Route::get('questions/create', 'PreferenceQuestionController@create')->name('question.create');
    Route::post('questions/create', 'PreferenceQuestionController@storeAdmin')->name('question.store');
    Route::get('question/edit/{id}', 'PreferenceQuestionController@edit')->name('question.edit');
    Route::put('question/edit/{id}', 'PreferenceQuestionController@updateAdmin')->name('question.update');
    Route::delete('questions/{id}', 'PreferenceQuestionController@destroy')->name('question.destroy');
    */
...
Route::middleware(['auth'])->group(function () {
    ...
    **********/
    ...
    Route::post('my-preferences/update', 'PreferenceQuestionController@update')->name('my.preferences.update');
...
Loan Page
************/
Route::get('loans', 'PageController@loans')->name('page.loans');
...
/*
Route::get('business-proposal/{slug}', 'BusinessProposalController@show')->name('business.proposals.show');
Route::get('business-proposals', 'BusinessProposalController@index')->name('business.proposals');
Route::post('business-proposals', 'BusinessProposalController@filter')->name('business.proposals.filter');
Route::get('business-proposals/category/{slug}', 'BusinessProposalController@index')->name('business.proposals');
*/
...
Route::post('resource', 'ResourceController@filter')->name('resource.filter');
Route::get('resource/category/{slug}', 'ResourceController@index')->name('resource');
*/
...
Route::post('blogs', 'BlogController@filter')->name('blog.filter');
Route::get('blogs/category/{slug}', 'BlogController@index')->name('blog');
*/
...
//Route::post('my-preferences/post', 'PreferenceQuestionController@store')->name('my.preferences.store');
...
//Route::post('inquiry/create', 'InquiryController@store')->name('inquiry.store');
...
/*
Route::post('cntc/store', 'ContactController@store')->name('contact.post');

Route::get('terms-and-condition', 'PageController@terms')->name('page.terms');
Route::get('about-us', 'PageController@about')->name('page.about');
Route::get('privacy', 'PageController@privacy')->name('page.privacy');
Route::get('media', 'PageController@media')->name('page.media');
...
Seeder 
*******/
//php artisan iseed answer_users,applications,blogs,blog_blog_categories,blog_categories,business_proposals,business_proposal_business_type,business_structures,business_types,business_type_resources,contacts,documents,failed_jobs,favourites,finance_information,inquiries,jobs,migrations,notifications,password_resets,preference_questions,question_answers,resources,review_documents,review_notes,roles,role_user,statuses,team_sizes,users;