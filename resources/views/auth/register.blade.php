            ...
            <div class="col-lg-8">
                <div class="fund_your_left">
                    ...
                    <div id="step-1" class="my-5 animated fadeInDown first-card">
                    	...
                    	<div class="pb-3">
                    		<a href="javascript:;" class="btn btn-success rounded-pill waves-effect waves-light btn-step-1">Next</a> 
                    	</div>
                    </div>
                    ...
                    <form action="{{ url('validate-step-2') }}" method="POST" onsubmit="return false;" name="contact-form" class="animated fadeInDown register-form new-register-form d-none" id="step-2" autocomplete="off">
                    	...
                    	<div class="form-row">
                    		<div class="form-group text-left col-xl-12  terms-condition"> By getting started you are agreeing to our <a target="_blank" href="{{ config('constants.wp_privacy_policy') }}">Terms &amp; Conditions</a> </div>
                    		<div class="form-group mb-0 text-center col-xl-12">
                    			<button class="btn btn-success btn-lg btn-block rounded-pill text-uppercase" id="btn-register" name="register" type="submit"> Get started </button>
                    		</div>
                    	</div>
                    	...
                    	<form action="{{ url('validate-step-3') }}" data-redirect="{{ url('loan/create') }}" method="POST" onsubmit="return false;" name="otp-form" class="comman-form" id="otp-form" autocomplete="off">
                        	...
                        	<div class="form-row pb-3">	
                    			<div class="form-group mb-0 text-center col-lg-6">
                    				<button class="btn btn-success btn-lg btn-block rounded-pill text-uppercase" id="btn-verify-otp" name="btn-verify-otp" type="submit"> Verify OTP </button>
                    			</div>
                    		</div>
                    	</form>
                    </div>
