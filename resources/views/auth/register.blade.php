...
@section('content')
	<section class="new_page_banner">
		<h1>fund your<span>{{ date('Y') }} vision</span></h1>
	</section>
	<section class="new_page_container py-5 bg-white">
		<div class="container new_design">
			<div class="row">
				<div class="col-lg-8">
					<div class="fund_your_left">
						<h2>start a business<span>loan application</span></h2>
						<p class="quick_easy_application mb-4">It won’t take long at all - quick & easy application!</p>
						<div id="step-1" class="my-5 animated fadeInDown first-card">
							<h4 class=""><strong>Are you applying for?</strong></h4>
							<div class="form-group ml-1 d-flex flex-column">
								<div class="radio radio-info form-check-inline">
									<input type="radio" id="apply_for_option" value="2" name="apply_for_option"
										checked="checked">
									<label for="inlineRadio1"> Knote Fast Business/Property backed Funding </label>
								</div>
							...
							<div class="pb-3">
								<a href="javascript:;"
									class="btn btn-success rounded-pill waves-effect waves-light btn-step-1">Next</a>
							</div>
						</div>
						<div id="step-5" class="d-none animated fadeInDown">
							...
							<div id="splash-details">
								...
								<div class="text-center mb-4 mt-4">
									<div class="role-4 role-3 d-none">
										<a href="{{ url('loan/create') }}"
											class="ml-1 btn btn-outline-success waves-effect waves-light">Create new loan
											application</a>
									</div>
								</div>
								...
								<p class="mt-3 text-dark font-weight-bold">We look forward to discussing your funding needs
									with you.</p>
							</div>
						</div>
						<form action="{{ url('validate-step-2') }}" method="POST" onsubmit="return false;"
							name="contact-form" class="animated fadeInDown register-form new-register-form d-none"
							id="step-2" autocomplete="off">
							@csrf
							<div class="form-group">
								<label for="name">Full name</label>
								<input name="fullname" id="fullname" autocomplete="off" type="fullname"
									class="form-control">
							</div>
							<div class="form-row">
								...
								<div class="col-md-6">
									...
									<div class="form-row">
										<div class="form-group col-12 col-md-12 col-lg-12" for="phone">
											<input name="phone" id="phone" type="text" class="form-control phone-field"
												autocomplete="off">
										</div>
									</div>
								</div>
							...
							<div class="form-row">
								<div class="form-group col-md-12">
									...
									<select id="know_about_us" name="know_about_us" class="form-control rounded-pill">
								...
								<div class="form-group col-md-6" style="display:none;">
									...
									<input name="know_about_us_others" id="know_about_us_others" autocomplete="off"
										type="text" class="form-control">
								</div>
							</div>
							<div class="form-group ">
								<div id="request_a_callback"
									class="custom-control checkbox checkbox-success form-check-inline pl-0">
							...
							<div class="form-row">
								<div class="form-group text-left col-xl-12  terms-condition"> By getting started you are
									agreeing to our <a target="_blank"
										href="{{ config('constants.wp_privacy_policy') }}">Terms &amp; Conditions</a> </div>
								<div class="form-group mb-0 text-center col-xl-12">
									<button class="btn btn-success btn-lg btn-block rounded-pill text-uppercase"
										id="btn-register" name="register" type="submit"> Get started </button>
								</div>
							</div>
								...
								<div class="text-center mb-4 mt-4">
									<div class="role-4 role-3 d-none">
										<a href="{{ url('dashboard') }}"
											class="btn btn-outline-dark waves-effect waves-light">Go to dashboard</a>
										<a href="{{ url('loan/create') }}"
											class="ml-1 btn btn-outline-success waves-effect waves-light">Create new loan
											application</a>
									</div>
						...
						<div id="step-3" class="my-5 d-none animated fadeInDown">
							<form action="{{ url('validate-step-3') }}" data-redirect="{{ url('loan/create') }}"
								method="POST" onsubmit="return false;" name="otp-form" class="comman-form" id="otp-form"
								autocomplete="off">
								<div class="form-row pb-3">
									<div class="form-group col-lg-6">
										<label for="name">Enter 6 Digits OTP Number</label>
										<input name="otp" id="otp" type="text" value="" class="form-control numbers-only"
											maxlength="6">
									</div>
								</div>
								<div class="form-row pb-3">
									<div class="form-group mb-0 text-center col-lg-6">
										<button class="btn btn-success btn-lg btn-block rounded-pill text-uppercase"
											id="btn-verify-otp" name="btn-verify-otp" type="submit"> Verify OTP </button>
									</div>
								</div>
							</form>
						</div>
