        ...
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="page-title-box">
                        <div class="page-title-right">
                            ...
                            <a href="{{ url('broker/loan-application/create') }}" class="btn btn-warning">Add New
                                Application</a>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-xl-3">
                    <a href="{{ url('broker/loan-applications') }}">
                                ...
                                <div class="col-10">
                                    <div class="text-right">
                                        <h3 class="text-dark my-1"><span
                                                data-plugin="counterup">{{ $application_count }}</span></h3>
                ...
                <div class="col-md-3 col-xl-3">
                    <a href="{{ url('broker/declined-loan-applications') }}">
                        <div class="card-box p-2">
                            <div class="row">
                                <div class="col-2">
                                    <div class="avatar-sm bg-success rounded">
                ...
                <div class="col-md-3 col-xl-3">
                    <a href="{{ url('broker/archived-loan-applications') }}">
                        <div class="card-box p-2">
                            <div class="row">
                                <div class="col-2">
                                    <div class="avatar-sm bg-success rounded">
                ...
                <div class="col-md-3 col-xl-3">
                    <a href="{{ url('broker/settled-loan-applications') }}">
                        <div class="card-box p-2">
                            <div class="row">
                                <div class="col-2">
                                    <div class="avatar-sm bg-success rounded">
...
@section('scripts')
    ...
    <script>
        $(function () {
            ...
            var table = $('.internal-data-table').DataTable({
                ...
                ajax: {
                    url: "{{ url('broker/loan-applications-ajax') }}",
                    data: function (data) {
    ...
    <script>
        function excel_download() {
            ...
            var csv_url = "{{ url('broker/current-loan-applications-export') }}?" + permater;
