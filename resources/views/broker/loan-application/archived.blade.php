...
@section('title', 'Archived Loan Applications - Knote')
@section('styles')
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item active">Archived Loan Applications</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Archived Loan Applications</h4>
                    </div>
                </div>
            </div>
...
@section('scripts')
    ...
    <script>
        $(function () {
            ...
            var table = $('.internal-data-table').DataTable({
                ...
                ajax: {
                    url: "{{ url('broker/archived-loan-applications-ajax') }}",
                    data: function (data) {
    ...
    <script>
        function excel_download() {
            ...
            var csv_url = "{{ url('broker/archived-loan-applications-export') }}?" + permater;
