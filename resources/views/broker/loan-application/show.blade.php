            ...
            <div class="page-title-box">
               <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                     <li class="breadcrumb-item active"><a title="Back" href="{{ url('broker/dashboard') }}" class="btn btn-success text-white">Back</a></li>
                  </ol>
               </div>
               <h4 class="page-title"><h4 class="page-title">Loan Application Number : <span class="text-success">{{ $application->application_number }}</span></h4></h4>
            </div>
         </div>
      </div>
                     ...
                     <form action="{{ url()->current() }}" id="loan-application-five" name="loan-application-five" method="post" onsubmit="return false;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 text-md-right">
                                <h3 class="header-title text-success mt-0 font-18">Status : {{ $application->current_status ? $application->current_status->status : '' }}</h3>
                            </div>
                        </div>
                        <hr>
                        ...
                        <h4 class="header-title mt-3 font-20 d-flex justify-content-between align-items-center">Generated Documents</h4>
                        <hr>
