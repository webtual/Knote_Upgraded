...
hr {border-top: 2px solid #1369589;}
...
<div class="content application-form">
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{route('broker.loan.application')}}">Current Loan Applications</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <form action="{{ route('broker.new.loan.application.store') }}" name="form_loan_application_create" id="form_loan_application_create" method="post" onsubmit="return false;" enctype="multipart/form-data" autocomplete="off">
                    <div class="card-box">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <fieldset class="d-fin-wrapper">
                                    <div class="row">
                                        <div class="col-md-4">
                                          <div class="form-group">
                                             <label for="">Full Name <span class="text-danger">*</span></label>
                                             <input type="text" class="form-control fullname" name="fullname" id="fullname" placeholder="Full Name" value="">
                                          </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="cust_email_address" name="cust_email_address" value="" class="form-control cust_email_address" placeholder="Email Address">
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label for="">Phone<span class="text-danger">*</span></label>
                                                <input type="text" id="phone" name="phone" value="" class="form-control phone-field phone" placeholder="Phone">
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
                            ...
                            <div class="col-lg-12">
                                <fieldset class="d-fin-wrapper">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-group new-select">
                                                ...
                                                <select class="custom-select" name="apply_for" id="apply_for">
                                                    ...
                                                    <option value="{{ $bt['id'] }}" {{ $bt['id'] == 2 ? 'selected' : '' }}>
                                                        {{ $bt['title'] }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                       ...
                                       <div class="col-md-3">
                                            <div class="form-group new-select">
                                                <label for="bs">How did you know about us?<span class="text-danger">*</span></label>
                        ...
                        <div class="row loan-form-page">
                            ...
                            <div class="col-lg-12">
                                <fieldset id="team_member" class="d-fin-wrapper">
                                    @include('partials.comman.loan.team_member_add_broker_new')
                                </fieldset>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <fieldset id="team_fin_member" class="d-fin-wrapper">
                                    @include('partials.comman.loan.team_member_financial_add_new')
                                </fieldset>
                        ...
                        <div class="inqtype-1 loan-form-page" style="display:none;">
                            ...
                            <div style="border: 1px solid #eee;padding: 20px;border-radius: 5px;margin-bottom: 20px;">
                                <div class="row">
                        ...
                        <div class="row inqtype-3 loan-form-page" style="display:none;">
                            ...
                            <div class="col-lg-12" id="crypto-sections-container">
                                <div class="d-crypto-sec" style="border: 1px solid #eee;padding: 20px;border-radius: 5px;margin-bottom: 20px;">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
        ...
        $.ajax ({
            ...
            success : function(response) {
                if(response.status == 200){
                    ...
                    setTimeout(function(){ 
                        @php
                            $url = route('broker.loan.application');
                        @endphp
            ...
            error: function (reject) {
                if (reject.status === 422) {
                    ...
                    $.each(errors, function (field_name, error) {
                        ...
                        }else if (field_name == "fullname" || field_name == "cust_email_address" || field_name == "phone" || field_name == "mobile_no" || field_name == "business_email" || field_name == "business_address" || field_name == "business_name" || field_name == "abn_acn" || field_name == "m_loan_amount" || field_name === "finance_periods" || field_name === "gross_income" || field_name === "total_expenses" || field_name === "net_income") {
    ...
    $.ajax({
        ...
        error: function(reject) {
            ...
            if (reject.status === 422) {
                ...
                let firstErrorElement = null; // Track first input with error
                ...
                $.each(errors, function(field_name, error) {
                    ...
                    if (field_name === "business_trade_year" || field_name == "year_established" || field_name == "business_structure" || field_name == "trade" || field_name == "know_about_us") {
                        ...
                        inputElement = $('select[name="'+field_name+'"]');
                        inputElement.next('span').after('<span class="help-block error-block text-danger"><small>'+error_text+'</small></span>');

                    } else if (field_name == "brief_notes") {

                        inputElement = $('textarea[name="'+field_name+'"]');
                        inputElement.after('<span class="help-block error-block text-danger"><small>'+error_text+'</small></span>');

                    } else if (field_name == "fullname" || field_name == "cust_email_address" || field_name == "phone" || field_name == "mobile_no" || field_name == "business_email" || field_name == "business_address" || field_name == "business_name" || field_name == "abn_acn" || field_name == "m_loan_amount" || field_name === "finance_periods" || field_name === "gross_income" || field_name === "total_expenses" || field_name === "net_income") {

                        inputElement = $('input[name="'+field_name+'"]');
                        inputElement.after('<span class="help-block error-block text-danger"><small>'+error_text+'</small></span>');
                        ...
                        if (field === "title" || field === "residential_status" || field === "marital_status" || field === "gender" || field === "time_in_business" || field === "time_at_business") {
                            ...
                            inputElement = $('.additional_clone').eq(number).find('select[name="'+field+'[]"]');
                            inputElement.next('span').after('<span class="help-block error-block text-danger"><small>'+error_text+'</small></span>');
                        
                        } else {

                            inputElement = $('.additional_clone').eq(number).find('input[name="'+field+'[]"]');
                            if (inputElement.length === 0) {
                                inputElement = $('.d-property-sec').eq(number).find('input[name="'+field+'[]"]');
                            }
                            if (inputElement.length === 0) {
                                inputElement = $('.assets-members').eq(number).find('input[name="'+field+'[]"]');
                            }
                    ...
                    //Save first errored element for focus
                    if (firstErrorElement === null && inputElement && inputElement.length > 0) {
