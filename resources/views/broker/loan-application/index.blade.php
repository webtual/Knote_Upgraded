...
@section('title', 'Current Loan Applications - Knote')
@section('styles')
                ...
                <div class="col-12">
                    <div class="page-title-box">
                        <div class="page-title-right">
                         ...
                         <li class="breadcrumb-item active">Current Loan Applications1</li>
                      </ol>-->
                            <a href="{{ url('broker/loan-application/create') }}" class="btn btn-warning">Add New
                                Application</a>
                        </div>
                        <h4 class="page-title">Current Loan Applications</h4>
                    </div>
                </div>
            </div>
