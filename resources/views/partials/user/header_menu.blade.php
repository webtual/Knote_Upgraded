<header id="header">
  <div class="container">
    ...
    <div id="logo" class="pull-left">
      <a href="{{ config('constants.wp_url') }}" class="scrollto"><img src="{{ asset('user/img/logo.png') }}" alt="" /></a>
    </div>
    ...
    <nav id="nav-menu-container">
      <ul class="nav-menu">
        ...
        @if(Auth::check())
          ...
          <li class="{{ request()->is('dashboard') ? 'menu-active' : '' }}"><a href="{{ url('dashboard') }}">Dashboard</a></li>
          @else
          <li class="{{ request()->is('dashboard') ? 'menu-active' : '' }}"><a href="{{ url('admin/dashboard') }}">Dashboard</a></li>
          @endif
        @endif
        ...
        @endif
        <li class="{{ request()->is('about-us') ? 'menu-active' : '' }}" ><a href="{{ route('page.about') }}">About Us</a></li>
