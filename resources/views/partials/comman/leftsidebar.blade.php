      ...
      <div id="sidebar-menu">
         <ul class="metismenu" id="side-menu">
            ...
            <li class="">
               <a href="javascript: void(0);" class="">
               <i class="fe-box"></i>
               <span> Business Proposals </span> <span class="menu-arrow"></span>
               </a>
               <ul class="nav-second-level" aria-expanded="false">
                  <li class="">
                     <a href="{{ url('business-proposals/create') }}">Add New Proposal</a>
                  </li>
                  <li>
                     <a href="{{ url('business-proposals') }}">View All Proposals</a>
                  </li>
                  <li>
                     <a href="{{ url('my-business-proposals') }}">My Proposals</a>
                  </li>
                  <li>
                     <a href="{{ url('business-proposals/favourites') }}">My Favourites</a>
                  </li>
               </ul>
            </li>
            <li class="">
               <a href="javascript: void(0);" class="">
               <i class="fe-layers"></i>
               <span> Resources </span> <span class="menu-arrow"></span>
               </a>
               <ul class="nav-second-level" aria-expanded="false">
                  <li class="">
                     <a href="{{ url('resource/create') }}">Add New Resources</a>
                  </li>
                  <li>
                     <a href="{{ url('resource') }}">View All Resources</a>
                  </li>
                  <li>
                     <a href="{{ url('my-resource') }}">My Resources</a>
                  </li>
                  <li>
                     <a href="{{ url('resource/favourites') }}">My Favourites</a>
                  </li>
               </ul>
            </li>
            <li>
               <a href="{{ url('investors') }}">
               <i class="fe-users"></i>
               <span> Investors </span>
               </a>
            </li>
            @elseif(auth()->user()->roles()->first()->role_name == "Entrepreneur")
            <li>
            ...
            @elseif(auth()->user()->roles()->first()->role_name == "Investor")
            <li class="">
               <a href="javascript: void(0);" class="">
               <i class="fe-box"></i>
               <span> Business Proposals </span> <span class="menu-arrow"></span>
