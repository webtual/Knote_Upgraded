<div class="modal fade edit_crypto_model" id="edit_crypto_model" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body loan-form-page">
                <form action="{{ route('loan.details.update.crypto.security') }}" name="form_crypto_edit"
                    id="form_crypto_edit" method="post" onsubmit="return false;" enctype="multipart/form-data">
