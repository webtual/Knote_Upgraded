<div class="modal fade edit_business_financial_model" id="edit_business_financial_model" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Edit Business Financial Information</h5>
            ...
            <div class="modal-body loan-form-page">
                <form action="{{ route('loan.details.update.business.financial') }}" name="form_business_financial_edit" id="form_business_financial_edit" method="post" onsubmit="return false;" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="business_financial_id" class="business_financial_id" value="">
                       ...
                       <div class="col-md-12">
                          <div class="form-group">
                             ...
                             <div class="radio form-check-inline">
                                <input type="radio" class="finance_periods" id="inlineRadio{{ $key }}_{{$application->id}}" value="{{ $key }}" name="finance_periods">
                                <label for="inlineRadio{{ $key }}_{{$application->id}}"> {{ ucfirst($value) }} </label>
                             </div>
                             @endforeach
                          </div>
                       </div>
                    ...
                    <div class="text-right">
                        <button type="submit" class="btn btn-success mr-2" id="form_business_financial_edit_btn">Update</button>
