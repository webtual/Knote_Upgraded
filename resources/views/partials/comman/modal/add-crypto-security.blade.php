<div class="modal fade add_crypto_model" id="add_crypto_model" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body loan-form-page">
                <form action="{{ route('loan.details.add.crypto.security') }}" name="form_crypto_add" id="form_crypto_add" method="post" onsubmit="return false;" enctype="multipart/form-data">
