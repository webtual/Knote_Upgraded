<div class="modal fade edit_security_model" id="edit_security_model" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body loan-form-page">
                <form action="{{ route('loan.details.update.property.security') }}" name="form_security_edit" id="form_security_edit" method="post" onsubmit="return false;" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="radio mt-1">
                                            <input type="radio" class="purpose" value="{{ $key }}" id="plt_{{ $key }}_{{ $value }}_{{$application->id}}" name="purpose">
                                            <label for="plt_{{ $key }}_{{ $value }}_{{$application->id}}"> {{ ucfirst($value) }} </label>
                                        </div>
                                        @endforeach
                        ...
                        <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <input type="text" name="property_address" class="form-control property_address property_address_val" id="business_address" placeholder="Property Address" value="" >
                              </div>
                            </div>
                            <div class="col-md-6">
