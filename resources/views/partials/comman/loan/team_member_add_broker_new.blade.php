<div class="additional_clone">
   <h4 class="mb-2 font-15 mt-2 font-weight-bold text-success header-title-dir">Directors Personal Financial Information : 1 </h4>
   <div class="row mt-1">
      <div class="col-md-2">
   ...
   <div class="row">
      ...
      <div class="col-md-6">
         <div class="form-group new-select new-select">
