<div class="left-side-menu color-knote cu-appli-left-nav">
   ...
   <div class="slimscroll-menu">
      ...
      <div id="sidebar-menu">
         <ul class="metismenu sidebar-menu-color-wt" id="side-menu">
            ...
            @if($enc_id == "")
                <li class="menu-title">Start application</li>
            ...
            @else
                ...
                <li class="{{ (request()->is('loan/edit')) ? 'active' : '' }}">
                   ...
                   <i class="fe-{{ ($fill_business_information) ? 'check' : 'briefcase' }}"></i>
                   <span> Business Information {{ $fill_business_information }}</span>
                   </a>
                </li>
            ...
            @endif
            <li class="">
               <a href="javascript:;" data-url="{{ url('register/loan-applicant') }}" class="font-17" data-flag="0" id="save-exit-loan-application">
