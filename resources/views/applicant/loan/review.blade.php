            	...
            	<div class="review-page">
                  <div class="tab-pane active" id="settings">
                     <form action="{{ url()->current() }}" id="loan-application-five" name="loan-application-five" method="post" onsubmit="return false;">
                        ...
                        <div class="mb-3">
                        	<h3 class="header-title font-18 border-bottom border-success pb-2">Business Information @if($application->status_id < 3)<a href="{{ url('loan/create/business-information') }}"><i class="fe-edit text-right edit-pin"></i></a>@endif</h3>
                        ...
                        <div class="mb-3">
                        	...
                        	<h3 class="header-title font-18 border-bottom border-success pb-2">Applicant/Director/Proprietor @if($application->status_id < 3)<a href="{{ url('loan/create/people') }}"><i class="fe-edit text-right edit-pin"></i></a> @endif</h3>
                        		<div class="basic-info review-section">
		                ...
		                <div class="mb-3">
	                        ...
	                        <h3 class="header-title font-18 border-bottom border-success pb-2">Business Financial Information @if(!empty($application->finance_information)) {{ '('.config('constants.finance_periods')[$application->finance_information->finance_periods].' - '.$application->finance_information->business_trade_year.')' }} @endif @if($application->status_id < 3)<a href="{{ url('loan/create/finance') }}"><i class="fe-edit text-right edit-pin"></i></a>
	                           @endif
	                        </h3>
	                        @else
	                         @php
                            ...
                            @endphp
	                        <h3 class="header-title font-18 border-bottom border-success pb-2">{{ $titles_vals[$application->apply_for] ?? '' }}  @if($application->status_id < 3)<a href="{{ url('loan/create/property-security') }}"><i class="fe-edit text-right edit-pin"></i></a>
	                           @endif
	                        </h3>
	                        @endif
                    	...
                    	<div class="mb-3">
	                        <h3 class="header-title font-18 border-bottom border-success pb-2">Document @if($application->status_id < 3)<a href="{{ url('loan/create/document') }}"><i class="fe-edit text-right edit-pin"></i></a>@endif </h3>
	                        <div class="table-responsive mt-2">
	                        ...
	                        <div class="text-center">
	                           <a href="{{ route('loan.create.document') }}" class="btn btn-light waves-effect waves-light z-two mt-2">
	                        ...
	                        @else
	                           ...
	                           <div class="text-center">
	                              <a href="{{ url('loan/edit/document/'.$enc_id) }}" class="btn btn-light waves-effect waves-light z-two mt-2">
                  ...
                  <div class="tab-pane active d-none" id="submit-success">
                        <div class="app-submit">
                            ...
                            <h4 class="header-title font-22 text-success mb-2">Thank You for Your Loan Application!</h4>
                            <p class="mb-0">Your application has been successfully submitted. Our team will review it shortly.</p>
                            <p>We will get back to you soon with further details. If you have any urgent inquiries, feel free to contact us.</p>
