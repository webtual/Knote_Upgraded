                            ...
                            <div class="form-row mb-0 justify-content-start">
                                <div class="col-lg-3">
                                    <div class="form-group mt-0">
                                        <label for="search_customer_no">Customer No</label>
                                        <input type="text" class="form-control" id="search_customer_no" name="search_customer_no" value="" placeholder="Customer No">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group mt-0">
...
<div class="modal fade edit_customer" id="edit_customer" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url('admin/users/update') }}" name="edit_customer_form" id="edit_customer_form" method="post" role="form" class="edit_customer_form" onsubmit="return false;">
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group input-pos-relative">
                                ...
                                <input type="text" id="phone" name="phone" value="" class="form-control phone-field" placeholder="Phone" autocomplete="off">
                            </div>
                        </div>
                        
                    </div>
                    <div class="text-right">
                        <button type="submit" class="btn btn-success mr-2 submit-edit-customer" id="submit-edit-customer">Update</button>
...
$(function () {
  ...
  var table = $('.internal-data-table').DataTable({
    ...
    ajax: {
        url:"{{ url('admin/users/ajax') }}",
        data: function(data){
            data.search_customer_no = $('#search_customer_no').val();
  ...
  $('body').on('click', '.customer-edit', function () {
    ...
    $('body').on('click', '.submit-edit-customer', function () {
...
function excel_download(){
    ...
    var search_customer_no = $('#search_customer_no').val();
    ...
    if(typeof search_customer_no === 'undefined'){ search_customer_no = ""; } else { search_customer_no = search_customer_no; }
    if(typeof search_daterange === 'undefined'){ search_daterange = ""; } else { search_daterange = search_daterange; }

    var permater = 'search_name=' + search_name + '&search_phone=' + search_phone + '&search_customer_no=' + search_customer_no + '&search_email=' + search_email + '&search_daterange=' + search_daterange;

    var csv_url = "{{ url('admin/users-export') }}?" + permater;
