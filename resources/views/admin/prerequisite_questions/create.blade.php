   ...
   <div class="row">
      <div class="col-12">
         <div class="page-title-box">
            ...
            <h4 class="page-title">New Prerequisite Question</h4>
         </div>
      </div>
   </div>
      ...
      <div class="col-lg-8">
         <form action="{{ url()->current() }}" id="prerequisite-question-form" name="prerequisite-question-form" method="post" onsubmit="return false;" enctype="multipart/form-data">
            <div class="card-box">
               <div class="row">
                  ...
                  <div class="col-md-6">
                     <div class="form-group mb-3">
                        ...
                        <input type="text" id="" name="question_title" value="" class="form-control" placeholder="Question Title">
                     </div>
                  </div>
               </div>
               <div class="row">
                  <div class="col-md-12">
                    <div class="form-group mb-3">
                        ...
                        <select class="custom-select selectpicker " name="field_type">
                           ...
                           <option value="{{ $field_type }}">{{ ucfirst($field_type) }}</option>
                           @endforeach
                        </select>
                     </div>
                  </div>
                        ...
                        <div class="row">
                           <div class="col-10">
                              <div class="input-field form-group mb-3">
                                 <input type="text" name="answer_text[]" class="form-control" placeholder="Answer Text">
                              </div>
                           </div>
                           <div class="col">
                              <div class="text-left">
                                 <button class="remove btn btn-xs btn-danger mt-1 d-none"><i class="mdi mdi-minus"></i></button>
                                 <button class="add_more btn btn-xs btn-info mt-1 ml-1"><i class="mdi mdi-plus"></i></button>
                              </div>
                           </div>
                        </div>
                     </fieldset>
               ...
               <hr>
               <button class="btn btn-primary mt-3" type="submit" id="prerequisite-question-add">Submit</button>
...
<script type="text/javascript">
   ...
   $('#prerequisite-question-add').click(function(){
      ...
      $.ajax ({
          ...
          success : function(response) {
            ...
            $('#prerequisite-question-form')[0].reset();
          },
