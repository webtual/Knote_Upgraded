...
<table style="width:100%">
    <tr>
        ...
        <td>
             ...
             <p class="briefnotes" style="text-align:right;">{{$team_size_data->firstname}} {{$team_size_data->lastname}}</p>
        </td>
    </tr>    
</table>
