                          ...
                          <tr>
                              ...
                              <td>
                                @if($value->inquirieable_id != null)
                                  {{ App\BusinessProposal::whereid($value->inquirieable_id)->pluck('title')->first() }}
                                @else
                                -
                                @endif
                              </td>
                              ...
                              <td>
                                <form action="{{url('admin/inquiry/business-proposals/'.$value->id)}}" class="cu-inline-block" method="POST">
                                  {{ method_field('DELETE') }}
                                  {{ csrf_field() }}
