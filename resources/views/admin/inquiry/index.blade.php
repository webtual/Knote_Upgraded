         ...
         <div class="col-12">
            <div class="page-title-box">
               <div class="page-title-right">
                  ...
                  <button type="button" class="btn btn-warning btn-add-newInquiry" id="btn-add-newInquiry">Add New Inquiry</button>
               </div>
                            ...
                            <div class="form-row mb-0 justify-content-start">
                                <div class="col-lg-3">
                                    <div class="form-group mt-0">
                                        ...
                                        <input type="text" class="form-control" id="search_name" name="search_name" value="" placeholder="Customer Name">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group mt-0">
                                        <label for="search_contact">Customer Contact</label>
                                        <input type="text" class="form-control" id="search_contact" name="search_contact" value="" placeholder="Customer Contact">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group mt-0">
                                        <label for="search_email">Customer Email</label>
                                        <input type="text" class="form-control" id="search_email" name="search_email" value="" placeholder="Customer Email">
                                    </div>
                                </div>
                                @php
...
<div class="modal fade add_inquiry" id="add_inquiry" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url('admin/inquiries-add') }}" name="add_inquiry_form" id="add_inquiry_form" method="post" role="form" class="add_inquiry_form" onsubmit="return false;">
                    @php
                        $apply_for = config('constants.apply_for');
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group input-pos-relative">
                                ...
                                <input type="text" name="fullname" class="form-control fullname" id="fullname" placeholder="Full Name" value="" maxlength="50" autocomplete="off" >
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group input-pos-relative">
                                <label for="">Email Address <span class="text-danger">*</span></label>
                                <input type="email" name="email" class="form-control email" id="email" placeholder="Email Address" value="" maxlength="50" autocomplete="off" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group input-pos-relative">
                                ...
                                <input type="text" name="phone" class="form-control phone-field phone" id="phone" placeholder="Phone" value="" autocomplete="off" >
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group input-pos-relative">
                        ...
                        <div class="col-md-12">
                            <div class="form-group input-pos-relative">
                                ...
                                <textarea name="message" class="form-control message" id="message" placeholder="Message" autocomplete="off" ></textarea>
                            </div>
                        </div>
                        
                    </div>
                    <div class="text-right">
                        <button type="submit" class="btn btn-success mr-2 submit-add-inquiry" id="submit-add-inquiry">Save</button>
...
<div class="modal fade edit_inquiry" id="edit_inquiry" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form action="{{ url('admin/inquiries-msg-update') }}" name="edit_inquiry_form" id="edit_inquiry_form" method="post" role="form" class="edit_inquiry_form" onsubmit="return false;">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group input-pos-relative">
                                <label for="">Message</label>
                                <textarea name="message_val" class="form-control message_val" id="message_val" rows="6" cols="60" placeholder="Message" autocomplete="off" ></textarea>
                    ...
                    <div class="text-right">
                        <button type="submit" class="btn btn-success mr-2 submit-edit-inquiry" id="submit-edit-inquiry">Save</button>
                        <button type="button" class="btn btn-info mr-2 close-notestag" data-dismiss="modal">Cancel</button>
                    </div>
                </form>
            </div>
