...
.c-text-left{width: 200px;display: inline-flex;}
.c-text-left-medium{width: 150px;display: inline-flex;}
.c-text-left-small{width: 60px;display: inline-flex;}
.d-property-sec-review{border: 1px solid #eee;padding: 14px;margin-bottom: 15px;}
                  ...
                  <div class="tab-pane active" id="settings">
                     <form action="{{ url()->current() }}" id="loan-application-five" name="loan-application-five" method="post" onsubmit="return false;">
                        ...
                        @php
                            ...
                            $application_cust_url = url('admin/users/loan-applications/'.Crypt::encrypt($application->user->id));
                        @endphp
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 text-md-right">
                                <a title="Download Application" href="{{ url('admin/loan/details/download/'.Crypt::encrypt($application->id)) }}" class="btn-sm btn-success text-white"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Download Application</a>
                            </div>
                        </div>
                        ...
                        @php
                            $url_1 = url('admin/loan/details/edit/'.\Crypt::encrypt($application->id));
                        @endphp
                        ...
                        <div class="row">
                            <div class="col-md-6 d-flex align-items-center">
                                <h3 class="header-title font-18">
                                    ...
                                    <!--<a href="{{ $url_1 }}"><i class="fe-edit text-right edit-pin text-success"></i></a>-->
                                    <a id="edit-business-application" href="javascript: void(0)"><i class="fe-edit text-right edit-pin text-success"></i></a>
                                </h3>
                            </div>
                            
                            @if($application->business_score)
                                <div class="col-md-6 text-md-right">
                                    <h3 class="header-title font-18 score-title-com" style="color: {{ $application->business_score < 600 ? '#dc3545' : '#28a745' }} !important;">
                        ...
                        <div class="table-responsive mt-2 c-border p-3">
                           ...
                           <div>
                              <strong class="font-13 text-muted  mb-1 c-text-left">Company Enquiry Score : </strong>
                              <span class="mb-3">{{ $application->business_score }}</span>
                           </div>
                           
                           <div>
                              <strong class="font-13 text-muted  mb-1 c-text-left">Company Trading History : </strong>
                              <span class="mb-3">{{ $application->company_trading_history_score }}</span>
                           </div>
                           ...
                           @endphp
                           <div>
                              <strong class="font-13 text-muted  mb-1 c-text-left">How did you know about us? : </strong>
                              <span class="mb-3">{{ $know_about_us_val }}</span>
                           </div>
                           <div>
                              <strong class="font-13 text-muted  mb-1 c-text-left">Brief Notes : </strong>
                           ...
                           <div class="d-flex justify-content-between align-items-center">
                                ...
                                @if(is_null($application->company_enquiry_at) || Carbon::parse($application->company_enquiry_at)->addDays(30)->isPast())
                                    <div class="">
                                        <a href="javascript:void(0);" class="btn-sm btn-success company-enquiry-score text-white mr-1" data-id="{{$application->id}}">
                                            <i class="fa fa-tachometer text-right text-white"></i> Check Company Enquiry Credit Score
                                        </a>
                                        <i class="fa fa-info-circle text-muted font-18" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Company Enquiry reports provide information on the structure and management of a Company, as well as a profile of the credit activity of the Company along with the option of requesting Credit scores and/or enriched information. Company enquiries can help determine an organisation’s credit worthiness apart from providing the entities’ identity/registration/public information."></i>
                                    </div>
                                @endif
                            </div>
			                ...
			                @foreach($application->latest_company_enquiry_credit_score_event_logs as $key_cs => $csh)
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="mb-0 ">
                                            <strong class="font-13 text-muted  mb-1">Enquiry Id : </strong>
                                            <span class="mb-2">{{ $csh->enquiry_id ?? '-'}}</span>
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="mb-0 ">
                                            <strong class="font-13 text-muted  mb-1">Score : </strong>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-0 ">
                                            <strong class="font-13 text-muted  mb-1">Created Date/Time : </strong>
                                            <span class="mb-2">{{ display_date_format_time($csh->created_at) ?? '-' }}</span>
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="mb-0 ">
                                            <strong class="font-13 text-muted  mb-1">Download Score PDF : </strong>
                                            @if($csh->is_error == 0 && $csh->score_pdf != null)
                                                <span class="mb-2"><a class="text-success" title="Download Score PDF" href="{{ asset('storage/'.$csh->score_pdf) }}" download><i class="mdi mdi-download mr-1 fs-22"></i></a></span>
                                            @else
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-0 ">
                                            <strong class="font-13 text-muted  mb-1">Score PDF Viewer : </strong>
                                            @if($csh->is_error == 0 && $csh->score_pdf != null)
                                                <span class="mb-2"><a class="text-success director-summary-btn" onclick="get_credit_score_event_log_data({{$csh->id}})"  title="Score PDF Viewer" href="javascript:void(0)"><i class="mdi mdi-clipboard-text mr-1 fs-22"></i></a></span>
                                            @else
                                                <span class="mb-2">-</span>
                                            @endif
                                        </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                @if(is_null($application->company_trading_history_at) || Carbon::parse($application->company_trading_history_at)->addDays(30)->isPast())
                                    <div class="">
                                        <a href="javascript:void(0);" class="btn-sm btn-success company-trading-history-score text-white mr-1" data-id="{{$application->id}}">
                                            <i class="fa fa-tachometer text-right text-white"></i> Check Company Trading History Credit Score
                                        </a>
                                        <i class="fa fa-info-circle text-muted font-18" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="A Company Trading History report provides a score and credit report of a Company. Company Trading History also provides a score and report for each director (up to 20), and lists the business relationships of those directors. The company score factors in directors’ credit activity in predicting the likelihood of future adverse or failure of the subject company."></i>
                                    </div>
                                @endif
                            </div>
			                ...
			                @foreach($application->latest_company_trading_enquiry_credit_score_event_logs as $key_ts => $cth)
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-0 ">
                                            <strong class="font-13 text-muted  mb-1">Created Date/Time : </strong>
                                            <span class="mb-2">{{ display_date_format_time($cth->created_at) ?? '-' }}</span>
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="mb-0 ">
                                            ...
                                            @if($cth->is_error == 0 && $cth->score_pdf != null)
                                                <span class="mb-2"><a class="text-success" title="Download Score PDF" href="{{ asset('storage'.$cth->score_pdf) }}" download><i class="mdi mdi-download mr-1 fs-22"></i></a></span>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-0 ">
                                            <strong class="font-13 text-muted  mb-1">Score PDF Viewer : </strong>
                                            @if($cth->is_error == 0 && $cth->score_pdf != null)
                                                <span class="mb-2"><a class="text-success director-summary-btn" onclick="get_credit_score_event_log_data({{$cth->id}})"  title="Score PDF Viewer" href="javascript:void(0)"><i class="mdi mdi-clipboard-text mr-1 fs-22"></i></a></span>
                                            @else
                                                <span class="mb-2">-</span>
                                            @endif
                                        </div>
                        ...
                        <div class="table-responsive mt-2 c-border p-3">
                           <div>
                              <strong class="font-13 text-muted  mb-1 c-text-left">Facility Limit (Approval) : </strong>
                              <span class="mb-3">${{ number_format($application->facility_limit, 2) }}</span>
                           </div>
                           <div>
                              <strong class="font-13 text-muted  mb-1 c-text-left">Facility Term (Approval) : </strong>
                              <span class="mb-3">{{ number_format($application->facility_term) }}</span>
                           </div>
                           <div>
                              <strong class="font-13 text-muted  mb-1 c-text-left">Applied Interest Rate (%) : </strong>
                              <span class="mb-3">{{ number_format($application->applied_interest_rate_per_month, 2) }}</span>
                           </div>
                           <div>
                              <strong class="font-13 text-muted  mb-1 c-text-left">Applied annual Interest (%) : </strong>
                              <span class="mb-3">{{ number_format($application->applied_annual_interest, 2) }}</span>
                           </div>
                            @php
                                $paymentTypes = [
                           ...
                           <div>
                              <strong class="font-13 text-muted  mb-1 c-text-left">Repayment amount : </strong>
                              <span class="mb-3">${{ number_format($application->repayment_amount, 2) }}</span>
                           </div>
                            @if($application->payment_type == 3)
                               <div>
                                  <strong class="font-13 text-muted  mb-1 c-text-left">Interest Capitalised : </strong>
                                  <span class="mb-3">${{ number_format($application->interest_capitalized, 2) }}</span>
                               </div>
                            @endif
                           <div>
                              <strong class="font-13 text-muted  mb-1 c-text-left">Repayment Description : </strong>
                           ...
                           <div>
                              <strong class="font-13 text-muted  mb-1 c-text-left">Documentation Fee : </strong>
                           ...
                           <div>
                              <strong class="font-13 text-muted  mb-1 c-text-left">Settlement Conditions : </strong>
                              <span class="mb-3">{{ $application->settlement_conditions_descriptions }}</span>
                           </div>
                           <div>
                              <strong class="font-13 text-muted  mb-1 c-text-left">Security Descriptions : </strong>
                           ...
                           <div>
                              <strong class="font-13 text-muted  mb-1 c-text-left">Land Address [Volume & Folio] : </strong>
                        ...
                        <h4 class="header-title mt-4 font-20 d-flex justify-content-between">Applicant/Director/Proprietor 
                            <a id="add-director" href="javascript: void(0)"><i class="fe-plus text-right edit-pin text-success"></i></a>
                        </h4>
                        <hr>
                        ...
                        <div class="c-border p-3 mb-2">
                            <div class="row">
                                <div class="col-md-6 d-flex align-items-center">
                                    <div class="mb-2 font-15 mt-0 font-weight-bold text-success">
                                        ...
                                        <a id="edit-director-application-{{ $key_team+1 }}" class="edit-director-application" data-id="{{$team->id}}" href="javascript: void(0)"><i class="fe-edit text-right edit-pin text-success"></i></a>
                                    </div>
                                </div>
                                @if($team->seeker_score)
                                    <div class="col-md-6 text-md-right">
                                        <h3 class="header-title font-18 score-title-com" style="color: {{ $team->seeker_score < 600 ? '#dc3545' : '#28a745' }} !important;">
                                            {{ $team->seeker_score }}
                                        </h3>
                                    </div>
                                @endif
                            ...
                            <div class="row">
                               <div class="col-md-6">
                                  ...
                                  <div>
                                    <strong class="font-13 text-muted mb-1 c-text-left-medium">Gender :</strong>
                                    <span class="mb-3">
                                        {{ $genderMap[$gender] ?? '-' }}
                                    </span>
                                  </div>
                               ...
                               <div class="col-md-6">
                                  ...
                                  <div>
                                     <strong class="font-13 text-muted  mb-1 c-text-left-medium">Email Address : </strong>
                            ...
                            @if($team->mobile != null && $team->email_address != null)
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="">
                                            <a href="javascript:void(0);" class="btn btn-success resent-consent text-white" data-id="{{$team->id}}" data-action="{{ url('admin/consent/resent') }}">
                                                <i class="fe-mail text-right text-white"></i> Resend
                                            </a>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-0 ">
                                            <strong class="font-13 text-muted  mb-1">Sent Date/Time : </strong>
                                            <span class="mb-2">{{ display_date_format_time($team->consent_sent_at) ?? '-' }}</span>
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="mb-0 ">
                                            <strong class="font-13 text-muted  mb-1">Verified Date/Time : </strong>
                                            <span class="mb-2">{{ display_date_format_time($team->verified_at) ?? '-' }}</span>
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="mb-0 ">
                                            <strong class="font-13 text-muted  mb-1">Download PDF : </strong>
                                            @if($team->consent_status == 1 && $team->consent_pdf_file != null)
                                                <span class="mb-2"><a class="text-success" title="Download Consent PDF" href="{{ asset('storage/'.$team->consent_pdf_file) }}" download><i class="mdi mdi-download mr-1 fs-22"></i></a></span>
                                            @else
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-0 ">
                                            <strong class="font-13 text-muted  mb-1">Status : </strong>
                                            <span class="mb-2">{{ $team->consent_status == 1 ? 'Yes' : 'No' }}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    @if(is_null($team->score_seeker_at) || Carbon::parse($team->score_seeker_at)->addDays(30)->isPast())
                                        <div class="">
                                            <a href="javascript:void(0);" class="btn-sm btn-success user-scoreseeker-score text-white mr-1" data-teamid="{{$team->id}}" data-id="{{$team->application_id}}">
                                                <i class="fa fa-tachometer text-right text-white"></i> Check ScoreSeeker Credit Score
                                            </a>
                                            <i class="fa fa-info-circle text-muted font-18" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="The Score Seeker is a credit reporting tool that provides a real-time credit score and credit report for individual/Directors of the company."></i>
                                        </div>
                                    @endif
                                </div>
			                    <!--<hr style="margin-top:5px;">-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-0 ">
                                            <strong class="font-13 text-muted  mb-1">Created Date/Time : </strong>
                                            <span class="mb-2">{{ display_date_format_time($cjs->created_at) ?? '-' }}</span>
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="mb-0 ">
                                            ...
                                            @if($cjs->is_error == 0 && $cjs->score_pdf != null)
                                                <span class="mb-2"><a class="text-success" title="Download Score PDF" href="{{ asset('storage'.$cjs->score_pdf) }}" download><i class="mdi mdi-download mr-1 fs-22"></i></a></span>
                                            @else
                                                <span class="mb-2">-</span>
                                            @endif
                                        </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-0 ">
                                            <strong class="font-13 text-muted  mb-1">Score PDF Viewer : </strong>
                                            @if($cjs->is_error == 0 && $cjs->score_pdf != null)
                                                <span class="mb-2"><a class="text-success director-summary-btn" onclick="get_credit_score_event_log_data({{$cjs->id}})"  title="Score PDF Viewer" href="javascript:void(0)"><i class="mdi mdi-clipboard-text mr-1 fs-22"></i></a></span>
                                            @else
                                                <span class="mb-2">-</span>
                                            @endif
                                        </div>
                        ...
                        @if($application->apply_for == 1)
                            <h4 class="header-title mt-3 font-20 d-flex justify-content-between">Business Financial Information @if(!empty($application->finance_information)) {{ '('.config('constants.finance_periods')[$application->finance_information->finance_periods].' - '.$application->finance_information->business_trade_year.')' }} @endif
                                
                                @if(empty($application->finance_information))
                                    <a id="add-business-financial" href="javascript: void(0)"><i class="fe-plus text-right edit-pin text-success"></i></a>
                                @endif
                            </h4>
                        @else
                             @php
                            ...
                            @endphp
                            <h4 class="header-title mt-3 font-20 d-flex justify-content-between">{{ $titles_vals[$application->apply_for] ?? '' }}
                                
                                @if($application->apply_for == 2)
                                    <a id="add-property-security" href="javascript: void(0)"><i class="fe-plus text-right edit-pin text-success"></i></a>
                                @endif
                                
                                @if($application->apply_for == 3)
                                    <a id="add-crypto-security" href="javascript: void(0)"><i class="fe-plus text-right edit-pin text-success"></i></a>
                                @endif
                            </h4>
                        @endif
                        <hr>
                        <div class="c-border p-3">
                            @if($application->apply_for == 1)
                                @if(!empty($application->finance_information))
                                    <div class="mb-2 font-15 font-weight-bold text-success">Business Financial Information
                                        <a id="edit-business-financial" class="edit-business-financial" data-id="@if(!empty($application->finance_information)){{$application->finance_information->id}}@endif" href="javascript: void(0)"><i class="fe-edit text-right edit-pin text-success"></i></a>
                                    </div>
                                    <div>
                                       <strong class="font-13 text-muted  mb-1 c-text-left">Gross Income : </strong>
                                       <span class="mb-3"> @if(!empty($application->finance_information)) {{ money_format_amount($application->finance_information->gross_income) }} 
                                       @endif</span>
                                    </div>
                                    <div>
                                       <strong class="font-13 text-muted  mb-1 c-text-left">Total Expense : </strong>
                                       <span class="mb-3">  @if(!empty($application->finance_information)) {{ money_format_amount($application->finance_information->total_expenses) }} 
                                       @endif</span>
                                    </div>
                                    <div>
                                       <strong class="font-13 text-muted  mb-1 c-text-left">Net Income : </strong>
                                       <span class="mb-3"> @if(!empty($application->finance_information)) {{ money_format_amount($application->finance_information->net_income) }} 
                                       @endif</span>
                                    </div>
                                    <hr>
                                @endif
                                    ...
                                    @if($application->apply_for == 2)
                                        <div class="wrapper-pro-securities">
        		                            ...
        		                            <div class="mb-2 font-15 font-weight-bold text-success">
        		                                ...
        		                                <a id="edit-property-security" data-id="{{$property->id}}" class="edit-property-security" href="javascript: void(0)"><i class="fe-edit text-right edit-pin text-success"></i></a>
        		                            </div>
                            ...
                            @forelse($application->team_sizes as $key_team => $team)
                                ...
                                @if($f_exp_row != null)    
                                <div class="mb-2 font-15 mt-2 font-weight-bold text-success">Directors Personal Financial information : {{ $key_team+1 }}
                                        <a id="edit-directors-financial" data-id="{{$f_exp_row->id}}" class="edit-directors-financial" href="javascript: void(0)"><i class="fe-edit text-right edit-pin text-success"></i></a>
                                </div>
                        ...
                        <h4 class="header-title mt-3 font-20 d-flex justify-content-between align-items-center">
                            <a id="edit-document" class="edit-document" href="javascript: void(0)">Document &nbsp;<i class="fe-edit text-right edit-pin text-success"></i></a>
                            
                            <a id="download-documents-sel" class="btn btn-success text-white" href="javascript:void(0);">
                            ...
                            <table class="table table-bordered table-centered mb-0">
                                <tbody>
                                    @php
                                        ...
                                        if($application->apply_for == 1){ unset($document_types['3']); }
                                    @endphp
                                    ...
                                    @foreach($document_types as $key => $value)
                                        ...
                                        <tr>
                                            <td class="review-tab-color-font" colspan="3"><strong>{{ $value }}</strong></td>
                                        </tr>
                        ...
                        <h4 class="header-title mt-3 font-20 d-flex justify-content-between align-items-center">
                            ...
                            <!--<a id="generate-documents" class="btn btn-success text-white" href="javascript:void(0);" onclick="generateDocuments({{ $application->id }})">
                                Generate All Documents
                            </a>-->
                            
                            <a id="generate-documents-sel" class="btn btn-success text-white" href="javascript:void(0);" onclick="generateDocumentsSel({{ $application->id }})">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-centered mb-0">
                                    <tbody>
                                            ...
                                            @foreach($approved_documents_data as $akey => $app_val)
                                                ...
                                                <tr>
                                                    <td class="review-tab-color-font" style="width:5%;">
                                                        <input id="appdocument{{ $akey }}" class="selectAppDocs" data-id="{{ $document_id }}" type="checkbox" name="appdocument">
                                                    </td>
                                                    ...
                                                    <td style="width:10%; text-align:center;">
                                                        @if($document_file)
                                                            <a class="text-success" href="{{ $document_file }}" target="_blank">
                                                                <i class="mdi mdi-download mr-1 fs-22"></i>
                                                            </a>
                                                        @else
                                                            <span class="text-danger">-</span>
                                        ...
                                        @else
                                            <tr>
                                                <td class="review-tab-color-font" style="text-align:center;" colspan="3">
                                                    No Record Found
                                                </td>
                                            </tr>
                                        @endif
         ...
         <div class="col-md-4">
            ...
            <div class="card-box" style="padding: 10px;">
                ...
                <div>
                    <div class="media mb-3 d-flex align-items-center">
                        ...
                        <div class="media-body">
                           <h4 class="mt-0 mb-1"><a href="{{$application_cust_url}}"><span class="text-success text-uppercase" style="">{{ $application->user->name }}</span></a></h4>
                           ...
                           <div class="text-left mt-2">
                              ...
                              <p class="text-muted mb-0 font-13"><strong class="c-text-left-small">No. :</strong> <span class="ml-2">{{  $application->user->customer_no }}</span></p>
                           </div>
                        </div>
                     </div>
                </div>
                ...
                <!--Write Review Note Start-->
                   ...
                   <form action="{{ url('admin/review-note/store') }}" id="write-review" name="loan-status-update" data-redirect="{{ url('admin/loan-applications') }}" method="post" onsubmit="return false;" enctype="multipart/form-data" class="mb-1">
                      ...
                      <input type="hidden" name="application_id" value="{{ $enc_id }}">
                      <button class="mt-3 btn btn-success btn-block" type="submit" id="review-note">Save Review Note</button>
                     
                   </form>
                   
                   @php
                   $max_height = ($application->review_notes->count() < 3) ? ($application->review_notes->count() * 80) : '300';
                   @endphp
                ...
                <!--Write Assessor Note Start-->
                   ...
                   <form action="{{ url('admin/assessor-review-note/store') }}" id="assessor-write-review" method="post" onsubmit="return false;" enctype="multipart/form-data" class="mb-1">
                      <div class="media">
                         <textarea class="form-control" rows="4" name="assessor_note" placeholder="Assessor Note" id="assessor_note"></textarea>
                      </div>
                      
                      <div class="mt-2">
                        <input class="form-control" type="file" name="assessor_file[]" id="assessor_file" multiple="" accept=".png, .jpeg, .jpg, .pdf, .doc, .docx">
                      </div>
                      
                      <input type="hidden" name="assessor_application_id" id="assessor_application_id" value="{{ $enc_id }}">
                      
                      <input type="hidden" name="application_id_val" id="application_id_val" value="{{ $application->id }}">
                      
                      <button class="mt-3 btn btn-success btn-block" type="submit" id="assessor-review-note">Save Assessor Note</button>
                   </form>
                ...
                <div class="card card-custom profile-detail mb-3 card-collapsed " data-card="true">
                        ...
                        <div class="card-toolbar w-100 justify-content-between bg-transparent" style="">
                            <ul class="nav nav-tabs nav-bold nav-tabs-line sidebar-line-tab ">
                                <li class="nav-item mr-1">
                                    <a class="nav-link active btn-success upload-document-tab" data-toggle="tab" href="#document">
                                        <span class="nav-icon">
                                ...
                                <li class="nav-item">
                                    <a href="#email-indent" aria-expanded="false" class="nav-link border email-indent-link" data-toggle="modal"
                    ...
                    <div class="card-body bg-eee">
                        <div class="tab-content pt-0">
                            <div class="tab-pane fade show active" id="document" role="tabpanel" ria-labelledby="document">
                                <div class="tab-content pt-0" id="document-tabs-content">
                                        <div class="sending-documents">
                                            <form action="{{ url('admin/application/upload/application-documents') }}"
                                                name="upload-application-document-form" method="post" onsubmit="return false;"
                                                enctype="multipart/form-data">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label class="mb-2 font-15 mt-0 font-weight-bold text-success">Attachments </label>
                                                            <div class="input-group">
                                                                <input type="file" accept="application/pdf" class="form-control"
                                                                    name="application_documents[]" multiple="multiple" value=""
                                            ...
                                            <div class="scroll scroll-pull" data-scroll="true" style="height: 300px;overflow: scroll;scrollbar-width: thin;scrollbar-color: #1abc9c #eee;">
                                                    ...
                                                    <div class="checkbox-list mb-6">
                                                        @if ($application->application_documents->count() != 0)
                                                            @foreach ($application->application_documents as $key_doc => $doc)
                                                                <label for="document{{ $key_doc }}" class="checkbox d-flex w-100 flex-wrap align-items-center">
                                                                    <input id="document{{ $key_doc }}" type="checkbox"
                                                                        class="my-cu-check-uncheck2 Attachments mr-1" name="sending-documents"
                                                                    ...
                                                                    <span style="width: 75%;">{{ str_replace('_', ' ', $doc->title) }}</span>
                                                                    <div class="d-flex ml-auto">
                                                                        <a href="{{ $doc->document_file_path() }}"
                                                                            target="blank" class="text-success"><i class="mdi mdi-download mr-1 fs-22"></i></a>
                                                                        @if ($doc->user_id == auth()->id())
                                                                            <a href="javascript:;" class="upload-document-delete"
                                                                                data-id="{{ $doc->id }}"><i class="mdi mdi-delete text-danger mr-1 fs-22"></i></a>
                                                                        @endif
                                                                    </div>
                                                                    <div class="w-100">
                                                                        <span class="text-muted">
                                                                            <i class="flaticon2-time"></i> {{ display_date_format($doc->created_at) }}
                                                                        </span>
                                                                    </div>
                                                                </label>
                                                            @endforeach
                ...
                <!--<button class="mt-3 btn btn-info btn-block" type="button" id="email-indent-model">Send Email Indent</button>-->
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body email-indent">
                <form id="email_send" action="{{ url('admin/application/send-email') }}" name="email_send_data_form" method="post" onsubmit="return false;" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="form-group">
                        <label>To Email ( Note : Entered multiple email id's with comma separator. for example abc@knote.com.au,xyz@knote.com.au )</label>
                        <input name="to" type="text" class="form-control form-control-solid" placeholder="To" value="{{$application->user->email}}" required>
                    </div>
                    <div class="form-group">
                        <label>Subject</label>
                        <input name="subject" type="text" class="form-control form-control-solid subject-val" placeholder="Subject" required>
                    </div>
                    <div class="form-group">
                        <label>Message</label>
                    ...
                    <div class="form-group attachment-add">
                        ...
                        <input type="file" accept="application/pdf" id="attachment_add" name="attachment_add[]" multiple="multiple" value="" class="form-control" aria-describedby="">
                    </div>
                    
                    <div id="attachment-files">
                    </div>
                    <input type="hidden" value="{{$application->id}}" id="application_id_val" name="application_id_val">
                    ...
                    <div class="form-group m-b-0">
                        <div class="text-right">
                            ...
                            <button type="button" class="btn btn-info" data-dismiss="modal" aria-hidden="true">Cancel</button>
                        </div>
                    </div>
                </form>
            </div>
...
<div id="director_summary" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="directorSummaryLabel" aria-hidden="true">
	<form method="post" action="" id="director_summary_form" name="director_summary_form" enctype="multipart/form-data">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="directorSummaryLabel"><i class="fa fa-file-pdf-o text-success"></i> Score PDF Viewer</h4>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<i aria-hidden="true" class="fa fa-close"></i>
					</button>
				</div>
...
<script>
    ...
    function get_credit_score_event_log_data(credit_score_event_log_id){
    	...
    	$.ajax({
    		...
    		type: "POST",
    		data: {'credit_score_event_log_id':credit_score_event_log_id},
    ...
    $(document).ready(function () {
        ...
        $('.selectAppDocs').on('change', function () {
            let selectedVals = $('#doc_sected_vals').val().split(',').filter(v => v); // Get current values as array
            ...
            if ($(this).is(':checked')) {
                ...
                selectedVals = selectedVals.filter(val => val !== docId.toString()); // Remove if unchecked
            }
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status === 200) {
                            toaserMessage('200', 'Director ScoreSeeker score checked successfully.');
                        } else {
                            toaserMessage('400', response.message || 'Something went wrong.');
                        }
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status === 200) {
                            toaserMessage('200', 'Company enquiry score checked successfully.');
                        } else {
                            toaserMessage('400', response.message || 'Something went wrong.');
                        }
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status === 200) {
                            toaserMessage('200', 'Company trading history score checked successfully.');
                        } else {
                            toaserMessage('400', response.message || 'Something went wrong.');
                        }
    ...
    function generateDocumentsSel(application_id){
        ...
        if(doc_sected_vals == ''){
        	...
        	$.ajax({
        		...
        		type: "POST",
        		data: {'application_id':application_id, 'doc_sected_vals' : doc_sected_vals},
        		headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
        		success: function( response ) {
        			$('.gocover').hide();
...
$(document).ready(function () {
    ...
    function calculateRepaymentPay3(facility_limit, facility_term, applied_interest_rate_per_month, application_fee, documentation_fee, other_fee, discharge_fee_val,monthly_acc_fee) {
        ...
        let facility_limit_val = parseFloat(facility_limit) + parseFloat(application_fee) + parseFloat(documentation_fee) + parseFloat(other_fee) + parseFloat(discharge_fee_val) + parseFloat(monthly_acc_fee);
    ...
    $('#payment_type').change(function () {
        ...
        var applied_interest_rate_per_month = parseFloat($('#applied_interest_rate_per_month').val()) || 0;
        ...
        if (paymentType == 1) {
            let result = calculateRepaymentPay1(facility_limit, facility_term, applied_annual_interest);
            ...
            let repayment_description =  facility_term+" payments of $"+LoanFirstRepaymentAmountVAL+" plus any applicable discharge fee on the last day of the period. Your interest charges and principal repayment for a payment period are due on the last day of the period and are intended to amortise. The amount of principal repayment due for each payment period is calculated by dividing the facility limit by the facility term (in months). You must pay us the secured money on the last day of the facility term.";
            
            $('#repayment_description').val(repayment_description);
        } else if (paymentType == 2) {
            let result = calculateRepaymentPay2(facility_limit, facility_term, applied_interest_rate_per_month);
            ...
            let repayment_description = facility_term+" payments of $"+totalExtraInterestMonthlyVAL+" followed by a final payment of "+facility_limit+" plus any applicable discharge fee on the last day of the period. Repayment Monthly repayments are to be made on the anniversary date of the first drawdown every month. You must pay us the secured money on the last day of the facility term.";
            
            $('#repayment_description').val(repayment_description);
            
        } else if (paymentType == 3) {
            let result = calculateRepaymentPay3(facility_limit, facility_term, applied_interest_rate_per_month, application_fee, documentation_fee, other_fee, discharge_fee_val,monthly_acc_fee);
            ...
            let repayment_description = "1 payment of $"+FinalTotalLoanAmountVAL+" at the end of Contract period plus any applicable discharge fee. \n\nRepayment \n\nYou must pay us the secured money on the last day of the facility term.";
...
$(document).on('keyup', '#applied_interest_rate_per_month, #facility_limit, #facility_term, #applied_annual_interest, #application_fee', function() {
...
function generateDocuments(application_id){
    $('.gocover').show();
	$.ajax({
    ...
    $.ajax ({
        ...
        success : function(response) {
            ...
            if(response.status == 201){
                ...
                $('<div class="error-block-attachment"><label id="title-error" class="error" for="title">Please checked any one document</label></div>').insertBefore('#upload-file-error-block');
            }
        }
    }); 
});
...
$('#attachment_add').on('change', function () {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.status === '201') {
                ...
                $.each(attachments, function (index, fileUrl) {
                    attachmentLinks += `<a href="${fileUrl}" target="_blank">${fileUrl.split('/').pop()}</a><br>`;
                });
        ...
        error: function (xhr) {
            ...
            let errorMsg = xhr.responseJSON ? xhr.responseJSON.message : 'Error while uploading attachments.';
            alert(errorMsg);
        }
    });
});
...
$('#request-document-file').click(function(){  
    ...
    if(request_documents != ""){
        ...
        $('.note-editable').html('<p>Dear <strong>Sir/Madam</strong>,</p><p>It was pleasure talking to you , hope our discussion has lead you in right direction. As per our conversation we will need following docs to structure our proposal</p><ul>'+file_name+'</ul><p>Once all docs in hand , we shall structure the file and call you with details of suited product as per need before I proceed.</p><p>Meanwhile please feel free to contact us for any queries.</p><br>');
        $('#con-close-modal').modal('show');
    }else{
        $('<div class="error-block-attachment"><label id="title-error" class="error" for="title">Please checked any one document</label></div>').insertBefore('#request-document-file');
    }
});
...
$('#send-mail-with-attach-file').click(function(){
    ...
    if(attachments_files != ""){
        ...
        $('<div class="error-block-attachment"><label id="title-error" class="error" for="title">Please checked any one document</label></div>').insertBefore('#send-mail-with-attach-file');
    }
});

$('body').on('click', '.upload-document-delete', function () {
    var id = $(this).attr('data-id'); 
    $(this).parents('label').fadeOut(300, function() { $(this).remove(); });
    $.ajax({
...
$('.mail-send-inquiry').click(function(){
    ...
    $.validator.addMethod(
        "multiemails",function(value, element, regexp){
        var allOk = true;
            if (value.indexOf(',') > -1) {
                var regex = /^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/;
    ...
    form.validate({
        ...
        rules: {
            ...
            summernote_message: { required: true },
        },
        messages: {
            email_template: { required: "Please select the email template" },
            to: {  required: "Please enter the to email", multiemails: "Please input valid to emails." },
            subject: { required: "Please enter the subject" },
            summernote_message: { required: "Please enter the message" },  
        },
    ...
    if (form.valid() == true){
        ...
        $.ajax({
            ...
            type: "POST",
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            data:{'application_id_val' : application_id_val, 'message' : message, 'email_to' : email_to, 'subject' : subject, 'attachments' : attachments, 'from_email' : from_email},
...
$('.edit-directors-financial').click(function(){
    ...
    $.ajax ({
        ...
        success : function(response) {
            ...
            $('.asset_property_primary_residence').val(response.data.asset_property_primary_residence);
            ...
            $('.liability_homeloan_repayment').val(response.data.liability_homeloan_repayment);
            $('.liability_otherloan_limit').val(response.data.liability_otherloan_limit);
            $('.liability_otherloan_repayment').val(response.data.liability_otherloan_repayment);
            $('.liability_all_card_limit').val(response.data.liability_all_card_limit);
            $('.liability_all_card_repayment').val(response.data.liability_all_card_repayment);
            $('.liability_car_personal_limit').val(response.data.liability_car_personal_limit);
            $('.liability_car_personal_repayment').val(response.data.liability_car_personal_repayment);
            $('.liability_living_expense_limit').val(response.data.liability_living_expense_limit);
            $('.liability_living_expense_repayment').val(response.data.liability_living_expense_repayment);
        ...
        error: function (reject) {
            if (reject.status === 422) {
                ...
                $.each(errors, function (field_name, error) {
                    ...
                    if (field_name == "asset_property_primary_residence" || field_name == "asset_property_other" || field_name == "asset_bank_account" || field_name == "asset_super" || field_name == "asset_other") {
                        ...
                        if (field === "title" || field === "residential_status" || field === "gender" || field === "marital_status" || field === "time_in_business" || field === "time_at_business") {
        ...
        error: function (reject) {
            if (reject.status === 422) {
                ...
                $.each(errors, function (field_name, error) {
                    ...
                    if (field_name == "gross_income" || field_name == "total_expenses" || field_name == "net_income") {
                        $('input[name="'+field_name+'"]').after('<span class="help-block error-block text-danger"><small>'+error_text+'</small></span>');
                    }else if (field_name === "business_trade_year") {
                        $('select[name="'+field_name+'"]').next('span').after('<span class="help-block error-block text-danger"><small>'+error_text+'</small></span>');
        ...
        error: function (reject) {
            if (reject.status === 422) {
                ...
                $.each(errors, function (field_name, error) {
                    ...
                    if (field_name == "property_address" || field_name == "property_value") {
                        $('input[name="'+field_name+'"]').after('<span class="help-block error-block text-danger"><small>'+error_text+'</small></span>');
                    }else {
                        var field = field_name.replace(/[0-9]/g, '').replace('.', '');
                        var number = field_name.replace(/\D/g, "");
...
$('.submit-conditionally-approved').click(function () {
    ...
    form.validate({
        ...
        rules: {
            facility_limit: { required: true },
            facility_term: { required: true },
            applied_interest_rate_per_month: { required: true },
            applied_annual_interest: { required: true },
            payment_type: { required: true },
            repayment_amount: { required: true },
            repayment_description: { required: true },
            settlement_conditions_descriptions: { required: true },
            application_fee: { required: true },
            documentation_fee: { required: true },
            valuation_fee: { required: true },
            discharge_fee: { required: true },
            other_fee: { required: true },
            disbursement_fees: { required: true },
            ppsr_value: { required: true },
            lvr_current: { required: true },
        },
        /*messages: {
