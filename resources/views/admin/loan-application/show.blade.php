...
<<<<<<< HEAD
                                                ...
                                                <div class="mt-0">
                                                    <div class="mb-2 font-15 font-weight-bold text-success">Referral Partner Details</div>
                                                ...
                                                @endif
=======
>>>>>>> 66f88ee0304642faf56e8baf8f19527d5c4bd3ec
                                                    ...
                                                    <table class="table table-bordered table-centered mb-0">
                                                        <tbody>
                                                            ...
                                                            @foreach ($document_types as $key => $value)
                                                                @php 
                                                                    $typeDocs = $application->get_documents_by_type($key); 
                                                                @endphp
