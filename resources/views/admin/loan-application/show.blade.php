            ...
            <div class="col-md-8">
                <div class="card-box">
                    ...
                    <div class="tab-content pt-0">
                        <div class="tab-pane active" id="settings">
                            <form action="{{ url()->current() }}" id="loan-application-five"
                                ...
                                <div class="table-responsive mt-2 c-border p-3">
                                    ...
                                    <div>
                                        <strong class="font-13 text-muted  mb-1 c-text-left">Company Enquiry Score :
                                        </strong>
                                        <span class="mb-3">{{ $application->business_score }}</span>
                                    </div>

                                    <div>
                                        <strong class="font-13 text-muted  mb-1 c-text-left">Company Trading History :
                                        </strong>
                                        ...
                                        @if(is_null($application->company_enquiry_at) || Carbon::parse($application->company_enquiry_at)->addDays(30)->isPast())
                                            <div class="">
                                                <a href="javascript:void(0);"
                                                    ...
                                                    <i class="fa fa-tachometer text-right text-white"></i> Check Company
                                                    Enquiry Credit Score
                                                </a>
                                                <i class="fa fa-info-circle text-muted font-18" aria-hidden="true"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="mb-0 ">
                                                    ...
                                                    @if($csh->is_error == 0 && $csh->score_pdf != null)
                                                        <span class="mb-2"><a class="text-success" title="Download Score PDF"
                                                                href="{{ asset('storage/' . $csh->score_pdf) }}" download><i
                                            ...
                                            <div class="col-xl-6">
                                                <div class="mb-0 ">
                                                    ...
                                                    @if($csh->is_error == 0 && $csh->score_pdf != null)
                                                        <span class="mb-2"><a class="text-success director-summary-btn"
                                                                onclick="get_credit_score_event_log_data({{$csh->id}})"
                                                                title="Score PDF Viewer" href="javascript:void(0)"><i
                                            ...
                                            <div class="col-xl-6">
                                                <div class="mb-0 ">
                                                    ...
                                                    @if($cth->is_error == 0 && $cth->score_pdf != null)
                                                        <span class="mb-2"><a class="text-success" title="Download Score PDF"
                                                                href="{{ asset('storage' . $cth->score_pdf) }}" download><i
                                                                    class="mdi mdi-download mr-1 fs-22"></i></a></span>
                                            ...
                                            <div class="col-md-6 d-flex align-items-center">
                                                <div class="mb-2 font-15 mt-0 font-weight-bold text-success">
                                                    ...
                                                    <a id="edit-director-application-{{ $key_team + 1 }}"
                                                        class="edit-director-application" data-id="{{$team->id}}"
                                            ...
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="">
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        data-id="{{$team->id}}" data-action="{{ url('admin/consent/resent') }}">
                                                ...
                                                <div class="col-xl-6">
                                                    <div class="mb-0 ">
                                                        ...
                                                        @if($team->consent_status == 1 && $team->consent_pdf_file != null)
                                                            <span class="mb-2"><a class="text-success" title="Download Consent PDF"
                                                                    href="{{ asset('storage/' . $team->consent_pdf_file) }}"
                                                                    download><i class="mdi mdi-download mr-1 fs-22"></i></a></span>
                                                        @else
                                                ...
                                                @if(is_null($team->score_seeker_at) || Carbon::parse($team->score_seeker_at)->addDays(30)->isPast())
                                                    <div class="">
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            data-teamid="{{$team->id}}" data-id="{{$team->application_id}}">
                                                            <i class="fa fa-tachometer text-right text-white"></i> Check ScoreSeeker
                                                            Credit Score
                                                        </a>
                                                        <i class="fa fa-info-circle text-muted font-18" aria-hidden="true"
                                                            data-toggle="tooltip" data-placement="top"
                                                    ...
                                                    <div class="col-xl-6">
                                                        <div class="mb-0 ">
                                                            ...
                                                            @if($cjs->is_error == 0 && $cjs->score_pdf != null)
                                                                <span class="mb-2"><a class="text-success" title="Download Score PDF"
                                                                        href="{{ asset('storage' . $cjs->score_pdf) }}" download><i
                                                                            class="mdi mdi-download mr-1 fs-22"></i></a></span>
                                                            @else
                                                                <span class="mb-2">-</span>
                                                            @endif
                        ...
                        <!--<h4 class="header-title mt-3 font-20">Exit Strategy and Brief Notes</h4>
                        <hr>
                        <div>
                            <span class="mb-3">{{ $application->brief_notes }}</span>
                        </div>-->
