            ...
            <div class="card-box">
                     ...
                     <div class="row"> 
                        ...
                        @foreach($blog_categories as $key => $bs)
                           ...
                           <div class="checkbox checkbox-success pb-1">
                              <input name="category[]" class="my-cu-check-uncheck-array" type="checkbox" id="inlineCheckbox{{ $key }}" value="{{ $bs->id }}" {{ ($result->category->contains($bs->id)) ? 'checked="checked"' : '' }} >
               ...
               <div class="row cropme-div">
                  <div class="col-md-12">
                     ...
                     <input type="hidden" name="image" value="{{ $result->main_image }}" class="form-control-file" required="required" >
                  </div>
               </div>
               <hr>
               <button class="btn btn-primary mt-3" type="submit" id="blog-update">Update</button>
