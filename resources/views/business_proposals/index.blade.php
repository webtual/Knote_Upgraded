      ...
      <div class="row">
         <div class="col-12">
            <div class="page-title-box">
               ...
               <h4 class="page-title">Business Proposals</h4>
            </div>
         </div>
      </div>
                     ...
                     <div class="pt-3 pb-4">
                        <form>
                           <div class="form-row align-items-center">
                              ...
                              <button type="button" class="btn waves-effect waves-light btn-blue" id="filter-business-proposal"><i class="fa fa-search mr-1"></i> Search</button>
                           </div>
                        </form>
                     </div>
                  </div>
            ...
            <div class="row mb-5 d-none" id="my-loadmore">
               <div class="col-md-12">
                  <div class="text-center">
                     <a href="javascript:;" id="bs-loadmore" data-url="{{ url()->current() }}" class="text-success font-18 "><i class="mdi mdi-spin mdi-loading mr-1 my-loader d-none"></i> LoadMore </a>
                  </div>
               </div>
            </div>
            @endif
