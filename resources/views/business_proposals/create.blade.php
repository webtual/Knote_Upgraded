...
<div class="container-fluid">
   <div class="row">
      <div class="col-12">
         <div class="page-title-box">
            ...
            <h4 class="page-title">New Business Proposal</h4>
         </div>
      </div>
   </div>
   ...
   <div class="row">
      <div class="col-lg-8">
         <form action="{{ url()->current() }}" id="business-proposals/create" name="business-proposals/create" method="post" onsubmit="return false;" enctype="multipart/form-data">
            <div class="card-box">
               <div class="row">
               ...
               <div class="form-group mb-3">
                  ...
                  <input type="text" name="location" value="" class="form-control algolia-places" placeholder="Location" >
               </div>
               ...
               <div class="row mb-3">
                  <div class="col-md-6">
                     ...
                     <input type="text" name="target" value=""  id="" class="form-control numbers-only" placeholder="Target" >
                  </div>
                  <div class="col-md-6">
                     <label for="">Min per Investor</label>
                     <input type="text" name="min_per_investor" value=""  id="" class="form-control numbers-only" placeholder="Min Per Investor">
                  </div>
               </div>
               <div class="form-group mb-3">
                  <label for="">Website</label>
                  <input type="text" id="" name="website" value="" class="form-control" placeholder="Website">
               </div>
               ...
               <div class="row cropme-div">
                  <div class="col-md-6">
                     ...
                     <input type="hidden" name="business_logo_image" class="form-control-file">

                  </div>
                  <div class="col-md-6">
                     <label for="example-fileinput">Banner Image<span class="text-danger">*</span></label>
                     <input type="file" id="business_banner_image" name="" class="form-control-file" data-width="1920" data-height="1080" data-type="rectangle">
                     <input type="hidden" name="business_banner_image" class="form-control-file">
                  </div>
               </div>
               <hr>
               <button class="btn btn-primary mt-3" type="submit" id="business-proposals-add">Submit</button>
