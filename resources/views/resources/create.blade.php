...
<div class="content">
   ...
   <div class="container-fluid">
      ...
      <div class="row">
      <div class="col-lg-8">
         <form action="{{ url()->current() }}" id="resource/create" name="resource/create" method="post" onsubmit="return false;" enctype="multipart/form-data">
            <div class="card-box">
               <div class="row">
               ...
               <div class="form-group mb-3">
                  ...
                  <textarea class="form-control summernote-editor" rows="5" name="description" placeholder="Description"></textarea>
               </div>
               <div class="row">
                  <div class="col-md-6">
                     <div class="form-group mb-3">
                        <label for="">Location<span class="text-danger">*</span></label>
                        <input type="text" name="location" value=""  id="" class="form-control algolia-places" placeholder="Location">
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group mb-3">
                        <label for="">Amount</label>
                        <input type="text" name="amount" value=""  id="" class="form-control numbers-only" placeholder="Amount">
                     </div>
                  </div>
               </div>
               ...
               <div class="row cropme-div">
                  <div class="col-md-6">
                     ...
                     <input type="hidden" name="resource_image" class="form-control-file">
                  </div>
               </div>
               <hr>
               <button class="btn btn-primary mt-3" type="submit" id="resource">Submit</button>
