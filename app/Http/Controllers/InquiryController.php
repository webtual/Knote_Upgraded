...
class InquiryController extends Controller
{
    ...
    public function businessProposals(){
        $inquiry = Inquiry::whereinquirieable_type('App\BusinessProposal')->orderBy('id','DESC')->get();
        return view('admin.inquiry.business_proposal_list', compact('inquiry'));
    }

    public function resources(){
        $inquiry = Inquiry::whereinquirieable_type('App\Resource')->orderBy('id','DESC')->get();
        return view('admin.inquiry.resource_list', compact('inquiry'));
    }

    public function businessProposalsDestory($id){
        $data = Inquiry::find($id);
        $data->delete();
        return back()->with('success','Record has been removed successfully.');
    }

    public function resourcesDestory($id){
        $data = Inquiry::find($id);
        $data->delete();
        return back()->with('success','Record has been removed successfully.');
    }
