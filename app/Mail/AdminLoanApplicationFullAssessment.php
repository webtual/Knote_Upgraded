...
class AdminLoanApplicationFullAssessment extends Mailable implements ShouldQueue
{
    ...
    public function build()
    {
        ...
        Log::info(PHP_EOL);
        Log::info('Sent mail to admin Full Assessment loan application', [
            'subject' => $sub, 
            'loan_application' => $this->loan_application
        ]);
        
        return $this->subject($sub)->markdown('emails.loan_application.admin-fullassessment', ['loan_application' => $this->loan_application]);
    }
}
