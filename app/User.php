...
class User extends Authenticatable implements MustVerifyEmail
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password', 'email_verified_at', 'phone', 'avtar', 'customer_no'
    ];
    ...
    public function favourite_business_proposals(){
        return $this->belongsToMany('App\BusinessProposal', 'favourites', 
        'user_id', 'favouriteable_id')->where('favouriteable_type', 'App\BusinessProposal')->where('favourites.deleted_at', null);
    }

    public function favourite_resources(){
        return $this->belongsToMany('App\Resource', 'favourites', 
        'user_id', 'favouriteable_id')->where('favouriteable_type', 'App\Resource')->where('favourites.deleted_at', null);
    }
