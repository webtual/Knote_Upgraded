    ...
    <soapenv:Body>
        <comth:request request-type="REPORT" client-reference="{$clientReferenceHeader}" xmlns:comth="http://vedaxml.com/vxml2/company-trading-history-v3-2.xsd">
            ...
            <ns2:enquiry type="credit-enquiry" xmlns:ns2="http://vedaxml.com/vxml2/company-trading-history-v3-2.xsd">
                <ns2:account-type code="{$accountType}">{$creditTypeMain}</ns2:account-type>
...
XML;
        ...
        //CURLOPT_URL => 'https://ctaau.apiconnect.equifax.com.au/cta/sys2/company-trading-history-v3-2',
        
        $ch = curl_init();
        curl_setopt_array($ch, [
            CURLOPT_URL => 'https://ctaau.vedaxml.com/cta/sys2/company-trading-history-v3-2',
